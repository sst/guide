...
We completely rewrote SST to be simpler, faster, and easier to work with. [Check out this video](https://youtu.be/qEKUNZWbj-8) to get a quick sense of what SST v2 is all about.
...
- _**And more...**_
  ...
  There's also a new cleaned up functions API and more. For all the details check out this preview of SST v2 we did recently.
