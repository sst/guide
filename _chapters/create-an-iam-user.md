...
This account will be used by our [AWS CLI](https://aws.amazon.com/cli/) and [Serverless Stack](https://serverless-stack.com). They'll be connecting to the AWS API directly and will not be using the Management Console.
