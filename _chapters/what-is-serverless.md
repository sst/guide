...
Aside from optimizing your functions, you can use simple tricks like a separate scheduled function to invoke your function every few minutes to keep it warm. [SST]({{ site.url }}), which we are going to be using in this tutorial, has a pre-built Cron component to help with this.
