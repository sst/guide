...
description: To let users create a note in our React.js app, we need to connect our form to our serverless API backend. We are going to use the AWS Amplify's API module for this.
context: frontend
code: frontend
comments_id: 48
---
