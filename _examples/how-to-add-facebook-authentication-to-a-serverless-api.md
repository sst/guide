...
In this example we will look at how to add Facebook authentication to a serverless API using [SST]({{ site.sst_github_repo }}).
...
```bash
$ npx create-sst@latest --template=minimal/typescript-starter api-auth-facebook
