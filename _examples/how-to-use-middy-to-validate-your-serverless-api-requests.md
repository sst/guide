...
**Important:** Compiling schemas on the fly will cause a 50-100ms performance hit during cold start for simple JSON Schemas. Precompiling is highly recommended, more info [here](https://github.com/willfarrell/middy-ajv)
