...
index: 3
# type: iam-auth
description: In this example we will look at how to add Google authentication to a serverless API using Serverless Stack (SST). We'll be using the Api and Auth construct to create an authenticated API.
