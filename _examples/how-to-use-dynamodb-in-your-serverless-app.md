...
This creates a serverless DynamoDB table using [`sst.Table`]({{ site.docs_url }}/constructs/Table). It has a primary key called `counter`. Our table is going to look something like this:
