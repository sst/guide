...
The version of the notes app used in this chapter is hosted in a separate GitHub repository: [**{{ site.frontend_user_mgmt_github_repo }}**]({{ site.frontend_user_mgmt_github_repo }}).
